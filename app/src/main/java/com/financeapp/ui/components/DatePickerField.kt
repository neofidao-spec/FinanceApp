...
fun DatePickerField(
    ...
    // Box with clickable wraps the OutlinedTextField
    // This way the click is captured by Box, not consumed by the read-only TextField
    Box(
        modifier = Modifier
            .fillMaxWidth()
        ...
        OutlinedTextField(
            ...
            label = { Text(label) },
            readOnly = true,
            enabled = false, // disabled so it doesn't consume clicks
